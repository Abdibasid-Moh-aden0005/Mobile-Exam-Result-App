...
const StudentProfileScreen = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.fullName}>{selectedStudent.firstName} {selectedStudent.lastName}</Text>
...
const styles = StyleSheet.create({
  ...
  fullName: { fontSize: 22, fontWeight: '700', textAlign: 'center', marginBottom: 24 },
